...
export default function Navbar() {
  ...
  return (
    // <nav className="bg-linear-to-r from-primary to-[#AA10EC] sticky top-0 z-50 shadow-inner rounded-none">
    <nav
      className="sticky top-0 z-50 shadow-inner rounded-none relative overflow-hidden"
      style={{
        background: `
      radial-gradient(ellipse 80% 120% at 50% -10%, #AA10EC 2%, var(--color-primary) 100%),
      linear-gradient(to right, var(--color-primary), #AA10EC)
    `,
      }}
    >
